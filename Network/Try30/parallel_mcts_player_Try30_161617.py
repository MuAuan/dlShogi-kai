...
from pydlshogi.network.policy_value_resnetTry30 import *
...
class ParallelMCTSPlayer(BasePlayer):
    def __init__(self):
        ...
        self.modelfile = r'C:\Users\tosio\fastText\path\to\corpus\AB\KerasExample\dlshogi\model\resnetTry30_161617\model_policy_value_resnetTry30_3'
        self.model = None # モデル
    ...
    def usi(self):
        ...
        print('option name playout type spin default ' + str(self.playout) + ' min 100 max 30000')
