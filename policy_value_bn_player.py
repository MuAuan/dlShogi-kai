...
from pydlshogi.network.policy_value_bn import *
...
class PolicyValuePlayer(BasePlayer):   
    def __init__(self):
        super().__init__()
        self.modelfile = r'C:\Users\user\chainer-3.5.0\dlShogi\model\model_policy_value_bn'   
        self.model = None

    def usi(self):
        print('id name policy_value_player_bn')
